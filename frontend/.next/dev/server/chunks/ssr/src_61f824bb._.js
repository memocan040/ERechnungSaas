...
function SettingsPage() {
    ...
    const loadData = async ()=>{
        try {
            const [userRes, settingsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].getCurrentUser(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["settingsApi"].get()
            ]);
    ...
    const handleSaveSettings = async ()=>{
        setSaving(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["settingsApi"].update(formData);
            if (response.success) {
    ...
    const handleChangePassword = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].changePassword(passwordData.currentPassword, passwordData.newPassword);
            if (response.success) {
...
//# sourceMappingURL=src_61f824bb._.js.map